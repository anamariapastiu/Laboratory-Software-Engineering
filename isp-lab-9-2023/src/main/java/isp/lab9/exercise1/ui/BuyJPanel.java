...
public class BuyJPanel extends JPanel {
    ...
    private void initComponents(){
        ...
        buyButton.addActionListener(e -> buy(symbolComboBox,costTextField,quantityTextField));
    ...
    private void buy(JComboBox<String> symbolComboBox,
                     JTextField costTextField,
                     JTextField quantityTextField) {
        System.out.println("USER IS BUYING SOMETHINg!!!");
        //citesc cantitatea si simbolul

        mainFrame.getPortfolio().
                addStocks(symbolComboBox.getSelectedItem().toString(),
